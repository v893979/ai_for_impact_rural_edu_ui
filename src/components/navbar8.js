      ...
      <header data-thq="thq-navbar" className="navbar8-navbar-interactive">
        ...
        <div data-thq="thq-navbar-nav" className="navbar8-desktop-menu">
          <nav className="navbar8-links1">
            ...
            <Link to="/student" className="thq-link thq-body-small">students</Link>
            <Link to="/teacher" className="thq-link thq-body-small">teachers</Link>
            <Link to="/parent" className="thq-link thq-body-small">parents</Link>
          </nav>
          <div className="navbar8-buttons1">
            <button className="navbar8-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar8-text23">Sign In</span>
                  </Fragment>
                )}
              </span>
            </button>
            <button className="navbar8-action21 thq-button-outline thq-button-animated">
              <span>
                {props.action2 ?? (
                  <Fragment>
                    <span className="navbar8-text20">Get Started</span>
                  </Fragment>
                )}
              </span>
            </button>
          ...
          <div className="navbar8-nav">
            ...
            <nav className="navbar8-links2">
              ...
              <a href={props.link2Url} className="thq-body-small thq-link">
                {props.link2 ?? (
                  <Fragment>
                    <span className="navbar8-text25">#features</span>
                  </Fragment>
                )}
              </a>
              <a
              ...
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="navbar8-text19">#teachers</span>
                  </Fragment>
                )}
              </a>
              <div className="navbar8-link4-accordion">
                ...
                >
                  <span className="thq-body-small thq-link">
                    {props.link4 ?? (
                      <Fragment>
                        <span className="navbar8-text21">#parents</span>
                      </Fragment>
                    )}
                  </span>
                      ...
                      <div className="navbar8-menu-item2">
                        ...
                        <div className="navbar8-content2">
                          <span className="navbar8-page21 thq-body-large">
                            {props.page2 ?? (
                              <Fragment>
                                <span className="navbar8-text27">Features</span>
                              </Fragment>
                            )}
                          </span>
                          <span className="thq-body-small">
                            {props.page2Description ?? (
                              <Fragment>
                                <span className="navbar8-text16">
                                  Explore our features including AI-Powered
                                  Virtual Tutor and Personalized Learning Paths.
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page3Description ?? (
                              <Fragment>
                                <span className="navbar8-text26">
                                  Tools for teachers to manage classrooms, track
                                  student progress, and personalize instruction.
                                </span>
                              </Fragment>
                            )}
                          </span>
                            ...
                            {props.page4Description ?? (
                              <Fragment>
                                <span className="navbar8-text18">
                                  ...
                                  communicate effectively with our parent
                                  dashboard.
                                </span>
                              </Fragment>
                            )}
                  ...
                  <div className="navbar8-content6">
                    ...
                    <span className="thq-body-small">
                      {props.page2Description ?? (
                        <Fragment>
                          <span className="navbar8-text16">
                            Explore our features including AI-Powered Virtual
                            Tutor and Personalized Learning Paths.
                          </span>
                        </Fragment>
                      )}
                    </span>
                ...
                <div className="navbar8-menu-item7">
                  ...
                  <div className="navbar8-content7">
                    <span className="navbar8-page32 thq-body-large">
                      {props.page3 ?? (
                        <Fragment>
                          <span className="navbar8-text24">For Teachers</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                ...
                <div className="navbar8-menu-item8">
                  ...
                  <div className="navbar8-content8">
                    <span className="navbar8-page42 thq-body-large">
                      {props.page4 ?? (
                        <Fragment>
                          <span className="navbar8-text22">For Parents</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.page4Description ?? (
                        <Fragment>
                          <span className="navbar8-text18">
                            Track your child&apos;s progress and communicate
                            effectively with our parent dashboard.
                          </span>
                        </Fragment>
                      )}
                    </span>
...
Navbar8.defaultProps = {
  link1: undefined,
  page1ImageSrc:
    'https://images.unsplash.com/photo-1649386525679-214da4fa6676?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjE4ODE3MXw&ixlib=rb-4.0.3&q=80&w=1080',
  page4ImageAlt: 'Image for For Parents Page',
  ...
  action2: undefined,
  page3ImageSrc:
    'https://images.unsplash.com/photo-1629470937819-43f1de3d321f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjE4ODE3Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1632649178247-ccef5f8fed9f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjE4ODE3Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  page3ImageAlt: 'Image for For Teachers Page',
  link4: undefined,
  ...
  logoAlt: 'Education & Tutoring Logo',
  page3: undefined,
  link2: undefined,
  page3Description: undefined,
  linkUrlPage4: 'https://www.teleporthq.io',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1623743993904-b913e870da4d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTczMjE4ODE3Mnw&ixlib=rb-4.0.3&q=80&w=1080',
  page2: undefined,
